        ...
        <div class="row g-5">
            <div class="col-lg-4 sticky-lg-top vh-100">
                <div class="d-flex flex-column h-100 text-center overflow-auto shadow">
                    <br>
                    <img class="img-fluid rounded-circle mb-4" src="img/profile.jpg" alt="Image" style="width: 175px; height: 175px; display: block; margin: 0 auto;">
                    <h3 class="text-primary mt-3">Pratchayapol Jampalad</h3>
                    <div class="mb-4" style="height: 22px;">
                        <h4 class="typed-text-output d-inline-block text-light"></h4>
                        <div class="typed-text d-none">FullStack Software Developer, System Administrator, Domain Management Services</div>
                    </div>
                    <div class="d-flex justify-content-center mt-auto mb-3">
                        ...
                        <a class="btn btn-secondary btn-square mx-1" href="https://www.facebook.com/P.Pratchayapol"><i class="fab fa-facebook-f"></i></a>
                    ...
                    <div class="d-flex align-items-end justify-content-between border-top">
                        ...
                        <a href="mailto:pratchayapol@pcnone.com" class="btn w-50 btn-scroll">Contact Me</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-8">
                ...
                <section class="py-5 border-bottom wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-6 py-1">
                            <span class="fw-medium text-primary">Name:</span> Pratchayapol Jampalad
                        </div>
                        <div class="col-sm-6 py-1">
                            <span class="fw-medium text-primary">Birthday:</span> 15 Nov 2000
                        </div>
                        <div class="col-sm-6 py-1">
                        ...
                        <div class="col-sm-6 py-1">
                            <span class="fw-medium text-primary">Phone:</span> +66 909691701
                        </div>
                        <div class="col-sm-6 py-1">
                            <span class="fw-medium text-primary">mail:</span> pratchayapol@pcnone.com
                        </div>
                        <div class="col-sm-6 py-1">
                            <span class="fw-medium text-primary">Address:</span> KhonKean, Thailand
                        </div>
                        <div class="col-sm-6 py-1">
                    ...
                    <div class="row g-4">
                        ...
                        <!-- <div class="col-md-4 col-lg-6 col-xl-4">
                            <div class="d-flex bg-secondary p-4">
                                <h1 class="flex-shrink-0 display-5 text-primary mb-0" data-toggle="counter-up">90</h1>
                                <div class="ps-3">
                ...
                <!-- Services Start -->
                <section class="py-5 border-bottom wow fadeInUp" data-wow-delay="0.1s">
                    <h1 class="title pb-3 mb-5">Technology</h1>
                    <div class="border-start border-2 border-light pt-2 ps-5">
                        ...
                        <div class="position-relative mb-4">
                            <span class="bi bi-arrow-right fs-4 text-light position-absolute" style="top: -5px; left: -50px;"></span>
                            <h5 class="mb-1">Git</h5>
                        </div>
                        <div class="position-relative mb-4">
                            <span class="bi bi-arrow-right fs-4 text-light position-absolute" style="top: -5px; left: -50px;"></span>
                            <h5 class="mb-1">Cloudflare</h5>
                        </div>
                        <div class="position-relative mb-4">
                            <span class="bi bi-arrow-right fs-4 text-light position-absolute" style="top: -5px; left: -50px;"></span>
                            <h5 class="mb-1">Proxmox</h5>
                        </div>
                        <div class="position-relative mb-4">
                            <span class="bi bi-arrow-right fs-4 text-light position-absolute" style="top: -5px; left: -50px;"></span>
                            <h5 class="mb-1">Vmware ESXI</h5>
                        </div>
                        <div class="position-relative mb-4">
                            <span class="bi bi-arrow-right fs-4 text-light position-absolute" style="top: -5px; left: -50px;"></span>
                ...
                <section class="wow fadeIn" data-wow-delay="0.1s">
                    <div class="bg-secondary text-light text-center p-5">
                        ...
                        <p class="m-0">&copy; All Rights Reserved. Designed by <a href="https://pcnone.com">PCNONE</a></p>
                    </div>
                </section>
                <!-- Footer End -->
            </div>
